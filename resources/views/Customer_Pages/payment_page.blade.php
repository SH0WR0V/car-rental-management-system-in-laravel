    ...
    <div class="container bootstrap snippets bootdey">
		<div class="row">
			<div class="col-md-12">
              ...
              {{@csrf_field()}}
              <input type="hidden" value="{{$client_info->id}}" name="client">
              <input type="hidden" value="{{$myinfo->id}}" name="my">
              <input type="hidden" value="{{$Clist->id}}" name="car">
								<strong><input type="text" name="payment_no"></strong>
