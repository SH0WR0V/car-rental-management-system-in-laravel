    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="project-info-box">
                <p><b>Dealer: </b>{{$Clist->car_owner_name}}</p>
        ...
        <div class="col-md-7">
            <img src="https://www.carmodelslist.com/wp-content/uploads/2012/04/Hyundai-Tucson.jpg" alt="project-image" class="rounded">
            <div class="project-info-box">
                <p><b>Car Name: </b>{{$Clist->car_name}}</p>
                <p><b>Car Model: </b>{{$Clist->car_model}}</p>
                <p><b>Rent Price: </b><b style="color:blue;">{{$Clist->rent_price}}</b><small> per day</small> </p>

                <a href="{{route('payment',['id'=>$Clist->id])}}" class="btn btn-primary">Confirm</a>
            </div><!-- / project-info-box -->
        </div><!-- / column -->
    </div>
</div>
